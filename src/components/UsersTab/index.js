...
// import followimage from './../../../public/assets/svg/following_image.svg';
// import followimage2 from './../../../public/assets/svg/following_image2.svg';
import "./style.scss";
...
const UsersTab = () => {
    ...
    const tabsData = [
        {
            key: 'following',
            title: `Following ${followingUsers.length}+`,
        ...
        {
            key: 'followers',
            title: `Followers ${followersUsers.length}+`,
