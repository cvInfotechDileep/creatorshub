...
export default function UserHeader() {
  ...
  //         clientId:
  //           '429500486669-t45dk6e5f7fhq12hk03qiuuu4u40f4m1.apps.googleusercontent.com',
  //         scope: 'profile email',
  //       });
  //     });
  //   };
        ...
        <Container fluid className='mx-4'>
          ...
          <Navbar.Collapse id='navbarScroll'>
            <Nav className='me-auto my-2 my-lg-0' style={{ maxHeight: '100px' }} navbarScroll>
              <Link href='/user/timeline' className='nav-link' onClick={() => handleLinkClick('/user/timeline')} style={activeLink === '/user/timeline' ? activeLinkStyle : {}}>Timelines</Link>
              <Link href='/user/my-page' className='nav-link' onClick={() => handleLinkClick('/user/my-page')} style={activeLink === '/user/my-page' ? activeLinkStyle : {}}>My Pages</Link>
              <Link href='/user/send-gifts' className='nav-link' onClick={() => handleLinkClick('/user/send-gifts')} style={activeLink === '/user/send-gifts' ? activeLinkStyle : {}}>Sent Gifts</Link>
              <Link href='/user/explore' className='nav-link' onClick={() => handleLinkClick('/user/explore')} style={activeLink === '/user/explore' ? activeLinkStyle : {}}>Explore</Link>
            </Nav>
