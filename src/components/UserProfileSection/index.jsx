                    ...
                    <div className='usernamebox w-100 py-4'>
                        <div className='username_balance'>
                            <div className='usernameblueicon'>
                                ...
                                <img src="/assets/svg/fanicon.svg" alt="" className='faniconcss' />
                            </div>
                            <div className='userbalancebox'>
                                <button className='btn btnbalance'>{`Balance: $0.00`}</button>
                                <div className='backgrey'>
                                    <img src="/assets/svg/settings.svg" alt="" className='greyimghover' />&nbsp;&nbsp;<img src="/assets/svg/share.svg" alt="" className='greyimghover' />
                                </div>
                            </div>
                        </div>
