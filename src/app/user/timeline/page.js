        ...
        <Row>
          <Col md={9} sm={12}>
            <Row className={`bg-white ${styles['livestreambox1']}`}>
              <h3>Live Streams</h3>
              <p className={styles['pgray']}>Upcoming & on-going live streams from creators you follow.</p>
            ...
            <Row className={`bg-white ${styles['livestreambox1']} my-4`}>
              <Row>
                <h3>Creators Hub</h3>
                <p className={styles['pgray']}>Stay up to date with updates from your favorite creators.</p>
                <hr className={styles["custom-hr"]} />
              ...
              <Row>
                ...
                <Row className={`align-items-center ${styles['giftmainbox']}`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                  ...
                  <Col md={8} className={styles['giftrightbox_2']}>
                    ...
                    <p className={styles['giftdescription_2']}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut et massa mi. Aliquam in hendrerit urna. Pellentesque sit amet sapien fringilla.</p>
